            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form:form class="form-horizontal row-border" commandName="room" role="form" method="POST" action="${pageContext.request.contextPath}/rooms/${room.id}.htm" >
                            <form:hidden path="id" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:input type="number" path="houseNumber" class="form-control" />
                                ...
                                <div class="col-md-8">
                                    <form:input class="form-control" type="number" path="maxStudents" name="maxStudents" min="1" max="3" />
                        ...
                        <div class="col-md-1">
                            <form:form method="POST" commandName="room" role="form" action="${pageContext.request.contextPath}/rooms/remove/${room.id}.htm" >
                                <form:hidden path="id" />
                                <input class="btn btn-warning" type="submit" path="room" name="delete_user" value="<spring:message code="lbl.deleteRoom"/>" onclick="return confirm('Are you sure you want to delete this room?')" />
                            </form:form>
                        </div>
                    </div>
                </div>
